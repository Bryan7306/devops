...
public class App {
    public static void main(String[] args) {
        ...
        // Initialise Department variable with chosen dept_name.
        Department newDept = a.getDepartment("Sales");

        // Create salaryList of all employees within select department.
        ArrayList<Employee> salaryList = a.getSalariesByDepartment(newDept);

        // Print Salary List.
        a.printSalaries(salaryList);
